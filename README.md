...
│   │   ├── predictive/      # Predictive maintenance page
│   │   ├── alerts/          # Alerts page
...
**Example**: If temperature is forecasted to reach 100°C in 6 hours (critical threshold: 95°C), the system alerts operators to take preventive action.
...
#### 3. **Remaining Useful Life (RUL) Estimation** ⏱️
...
```
Sensor Data → Data Pipeline → Feature Extraction
                                    ↓
                    ┌───────────────┴───────────────┐
                    ↓                               ↓
